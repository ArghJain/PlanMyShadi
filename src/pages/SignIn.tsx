  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-16">
        <section className="py-20 bg-gradient-to-br from-rose-50 via-white to-pink-50 min-h-screen flex items-center">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                  ...
                  <div>
                    ...
                    <div className="relative mt-2">
                      ...
                      <Input
                        ...
                        className="pl-10 h-12 border-gray-300 focus:border-rose-500 focus:ring-rose-500"
                  ...
                  <div>
                    ...
                    <div className="relative mt-2">
                      ...
                      <Input
                        ...
                        onChange={handleInputChange}
                        className="pl-10 pr-10 h-12 border-gray-300 focus:border-rose-500 focus:ring-rose-500"
                ...
                <div className="mt-8 text-center">
                  <p className="text-gray-600">
                    ...
                    <Link to="/join-vendor" className="text-rose-600 hover:text-rose-700 font-medium">
                      Sign up here
                    </Link>
                  </p>
                </div>
